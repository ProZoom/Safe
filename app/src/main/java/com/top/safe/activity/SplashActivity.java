...
import com.top.safe.UpdateDialog;
import com.top.safe.bean.VersionBean;
import com.top.safe.engine.TastManagerEngine;
import com.top.safe.utils.L;
import com.top.safe.utils.T;
...
import static com.top.safe.utils.Contents.VersionName;
import static com.top.safe.utils.Contents.VersionCode;
        ...
        new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    URL url=new URL("http://192.168.0.104:8080/version.json");
